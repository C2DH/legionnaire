...
export default function init(containerTarget) {
	...
	container.style.marginLeft = -margin /*Math.round( w * -0.5 )*/ + 'px';
	container.style.marginTop = -margin /*Math.round( h * -0.5 )*/ + 'px';
